  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          ...
          accept: "/repairs/repairInfo/repair/accept",
        },
      }
    },
    created () {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        //'adress','cont','evalCont','evalDegree','name','pic','staffId','staffName','stateTag','tel','title','userId','vistBz'
        this.$nextTick(() => {
