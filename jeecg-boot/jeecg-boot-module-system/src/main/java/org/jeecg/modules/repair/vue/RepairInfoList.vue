  ...
  export default {
    ...
    data () {
      return {
		...
		url: {
          list: "/repair/repairInfo/list",
          delete: "/repair/repairInfo/delete",
          deleteBatch: "/repair/repairInfo/deleteBatch",
          exportXlsUrl: "repair/repairInfo/exportXls",
          importExcelUrl: "repair/repairInfo/importExcel",
       },
    }
  },
  computed: {
